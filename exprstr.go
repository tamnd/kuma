...
// schema S.
func NewStrCol[S any](name string) StrCol[S] { return StrCol[S]{strops[S]{plan.Col(name)}} }
...
type strops[S any] struct{ n *plan.Expr }

func (o strops[S]) expr() *plan.Expr { return o.n }
...
func (o strops[S]) Eq(v string) BoolExpr[S] { return o.cmp(kernel.OpEq, plan.Lit(v)) }

// Ne returns whether the value differs from v.
func (o strops[S]) Ne(v string) BoolExpr[S] { return o.cmp(kernel.OpNe, plan.Lit(v)) }

// Lt returns whether the value sorts before v.
func (o strops[S]) Lt(v string) BoolExpr[S] { return o.cmp(kernel.OpLt, plan.Lit(v)) }

// Le returns whether the value sorts before v or equals it.
func (o strops[S]) Le(v string) BoolExpr[S] { return o.cmp(kernel.OpLe, plan.Lit(v)) }

// Gt returns whether the value sorts after v.
func (o strops[S]) Gt(v string) BoolExpr[S] { return o.cmp(kernel.OpGt, plan.Lit(v)) }

// Ge returns whether the value sorts after v or equals it.
func (o strops[S]) Ge(v string) BoolExpr[S] { return o.cmp(kernel.OpGe, plan.Lit(v)) }
...
// the empty string.
func (o strops[S]) IsNull() BoolExpr[S] { return boolOf[S](plan.IsNull(o.n)) }

// IsNotNull returns whether the value is there.
func (o strops[S]) IsNotNull() BoolExpr[S] { return boolOf[S](plan.IsNotNull(o.n)) }

func (o strops[S]) cmp(op kernel.CompareOp, r *plan.Expr) BoolExpr[S] {
