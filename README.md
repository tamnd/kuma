...
`TradeCols` is fifteen lines generated by `kumagen` from a struct, or from a Parquet file, a CSV sample or a SQL table. You can also write it by hand. Details are in [docs/03-typed-api.md](docs/03-typed-api.md).
